      ...
      <Sheet>
        <SheetTrigger asChild>
          <Button
            variant='ghost'
            size='icon'
            className='m-4 fixed top-4 right-4 x-50 border-2 hover:border-primary bg-neutral-800
              ...
              {socialLinks.map((social, i) => {
                ...
                return (
                  <a
                    ...
                    border-2 border-neutral-500 p-2 rounded-full hover:border-primary transition duration-200'
                  >
